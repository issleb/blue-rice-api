...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *BlueRice.Api.Lambda*):

Restore dependencies
```
    cd "BlueRice.Api.Lambda"
    dotnet restore
```

Execute unit tests
```
    cd "BlueRice.Api.Lambda/test/BlueRice.Api.Lambda.Tests"
    dotnet test
```

Deploy application
```
    cd "BlueRice.Api.Lambda/src/BlueRice.Api.Lambda"
